...
{   
    ...
    let [message,setMessage]=useState(null);
     ...
     {
        delivery.current[property]=value;
     }
     ...
     function register()
     {
           fetch('http://localhost:8000/delivery/create',{
                ...
                body:JSON.stringify(delivery.current)
           })   
           ...
           <div className="login-container">
                   ...
                   <div className='login'>
                       ...
                       <input type="text" className='form-control' placeholder="Enter Address" onChange={(e)=>{
                        ...
                        <input type="text" className='form-control' placeholder="Enter Serving Pin Code" onChange={(e)=>{
